...
import 'package:geolocalizacionamd/app/pages/sources/change_password/bloc/change_password_bloc.dart';
          ...
          await showDialog(
              ...
              builder: (BuildContext context) {
                return CustomDialogBox(
                  ...
                  type: AppConstants.statusSuccess, dialogCancel: () {  },
          ...
          await showDialog(
              ...
              builder: (BuildContext context) {
                return CustomDialogBox(
                  ...
                  type: AppConstants.statusError, dialogCancel: () {  },
                  isdialogCancel: false,
                );
              });
                  ...
                  TextFormField(
                    ...
                    validator: (value) {
                      return PasswordValidation()
                          .confirmPasswordValidator(value!, widget.passwordCtrl.text);
                    },
                    obscuringCharacter: '*',
                    style: const TextStyle(
                        color: Colors.white,
